...
git branch -M main
git remote add origin git@github.com:QuantumApplicationLab/quantum-inspired-algorithms
```
...
and create a new repository named `quantum-inspired-algorithms` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/QuantumApplicationLab/quantum-inspired-algorithms/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
